  ...
  <div class="container">
    <div id="intro" class="row">
      <div class="col-xs-12">
        ...
        <p class="wet-asphalt-text">Finally to bring it all together we use <a title="Automate and enhance your workflow" href="http://gulpjs.com/">Gulp</a> which runs several tedious time consuming tasks in a matter of seconds. And not that <a title="Automate and enhance your workflow" href="http://gulpjs.com/">Gulp</a> isn't already good enough, we actually use a wrapper for it called <a href="https://github.com/laravel/elixir">Elixir</a> which was developed by <a title="Creator of Laravel" href="https://twitter.com/taylorotwell">Taylor Otwell</a> and his team at <a title="The PHP Framework For Web Artisans" href="http://laravel.com/">Laravel</a>. <a href="https://github.com/laravel/elixir">Elixir</a> allows us to write these task in a simpler and more efficient manner.</p>
      </div>
    </div>
    <div class="row">
      <div class="col-xs-12">

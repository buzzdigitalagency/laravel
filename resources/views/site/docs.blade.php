  ...
  <div class="container">
    <div id="intro" class="row">
      <div class="col-xs-12">
        ...
        <p class="wet-asphalt-text m-t-md">This is meant to be a guideline for our team, as well as anyone else who would like to use it.</p>
        ...
        <p class="wet-asphalt-text">Our front end scaffold includes many different tools as well as a few additions done by <a title="Buzz Digital Agency" class="docs-link underline" href="http://buzzdigitalagency.com/">our team</a>.</p>
        <p class="wet-asphalt-text">First and foremost, we build our entire styles with <a title="Syntactically Awesome Style Sheets" class="peter-link" href="http://sass-lang.com/">SASS</a>, this allows us to do truly amazing work, but more importantly it allows us to do more efficient work. SASS also allows us to use variables for things like colors, paddings, magins, as well as many others. By doing this we can change a couple of assingned variables and change the whole application.</p>
